<?php
  ...
  //$sql_consulta = "SELECT * FROM mensajes WHERE (usuarioOrigen='$usuario' AND usuarioDestino='$usuarioDestino') OR (usuarioOrigen='$usuarioDestino' AND usuarioDestino='$usuario')";  
    $sql_consulta = "SELECT * FROM gestion_eecc WHERE (usuarioOrigen='$usuario' AND usuarioDestino='$usuarioDestino') OR (usuarioOrigen='$usuarioDestino' AND usuarioDestino='$usuario')";
